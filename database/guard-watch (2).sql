...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2024 at 11:31 AM
...
-- Error reading data for table guard-watch.contacts: #2006 - MySQL server has gone away
...
<a href="index.php?route=/database/sql&sql_query=SET+SQL_QUOTE_SHOW_CREATE+%3D+1&show_query=1&db=guard-watch"><span class="text-nowrap"><img src="themes/dot.gif" title="Edit" alt="Edit" class="icon ic_b_edit">&nbsp;Edit</span></a>    </p>
<p>
<code class="sql"><pre>
